          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
            ...
            <tr>
              <td style="font-family: Arial, Helvetica, sans-serif; padding: 20px 0 0 0;">
                <p style="margin: 0;">A request has been received from Ejaz Patient Care. See below for more information:</p>
              </td>
            </tr>
            <tr>
                <td style="font-family: Arial, Helvetica, sans-serif; padding: 20px 0 0 0;">
      ...
      <tr>
        <td bgcolor="#F5F5F5" style="padding: 5px 10px 5px 10px">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;" align="left">
                <tr>
                    <td style="width: 90px;">
                        <img style="width: 90px;" src="https://res.cloudinary.com/eforte/image/upload/v1638875522/ejaz-patient-care-logo_wssl1h.svg"/>
                    </td>
                    ...
                    <td style="width: 430px; padding-left: 10px;">
                          <p style="color:#5bb286; margin: 0 12px;"> 
                            ...
                            <p style="font-size: small; color: #000; margin: 2px;"> 
                                <strong style="color: #5bb286;">a:</strong>  Ejaz Patient Care | Shop no 25, Jason terrace Clifton block 2, Karachi.
                            </p>
                            <p style= "font-size: small; color: #000; margin: 2px;"> 
                                <strong style="color: #5bb286;">e:</strong> <a class="fa" href="mailto:ejazpatientcare@gmail.com"  style="color:darkgreen; text-decoration: underline;">ejazpatientcare@gmail.com</a>
                                | <strong  style="color: #5bb286;">w:</strong> <a class="fa" href="https://www.ejazpatientcare.com" target="blank" style="color:darkgreen; text-decoration: underline;">www.ejazpatientcare.com</a>
                            </p>
  ...
  <tr>
    <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
        ...
        <tr>
          <td style="font-family: Arial, Helvetica, sans-serif; padding: 20px 0 0 0;">
            <p style="margin: 0;">Thankyou for your interest in Ejaz Patient Care</p>
            <p style="margin-top: 15px;">Our team will be in coordination with you shortly</p>
            <p style="margin-top: 30px;">To learn more about Ejaz Patient Care, please visit our website at <a class="fa" href="https://www.ejazpatientcare.com" target="blank" style="color:darkgreen; text-decoration: underline;">www.ejazpatientcare.com</a></p>
          </td>
        </tr>
      </table>
    </td>
